    ...
    t.JQPlugin.createPlugin({
        ...
        _init: function() {
            ...
            var s = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || null
              , o = 0;
            !s || t.noRequestAnimationFrame ? (t.noRequestAnimationFrame = null,
            setInterval(function() {
                e._updateElems()
            }, 980)) : (o = window.animationStartTime || window.webkitAnimationStartTime || window.mozAnimationStartTime || window.oAnimationStartTime || window.msAnimationStartTime || i(),
            s(function t(a) {
                var r = a < 1e12 ? n ? performance.now() + performance.timing.navigationStart : i() : a || i();
                r - o >= 1e3 && (e._updateElems(),
                o = r),
                s(t)
            }))
        },
        ...
        _adjustSettings: function(e, i, n) {
            ...
            (n || !n && null == i._until && null == i._since) && (i._since = i.options.since,
            null != i._since && (i._since = this.UTCDate(_, this._determineTime(i._since, null)),
            i._since && o && i._since.setMilliseconds(i._since.getMilliseconds() + o)),
        ...
        _determineTime: function(t, e) {
            var i = this
              , n = null == t ? e : "string" == typeof t ? function(t) {
                t = t.toLowerCase();
                for (var e = new Date, n = e.getFullYear(), s = e.getMonth(), o = e.getDate(), a = e.getHours(), r = e.getMinutes(), l = e.getSeconds(), _ = /([+-]?[0-9]+)\s*(s|m|h|d|w|o|y)?/g, p = _.exec(t); p; ) {
                    switch (p[2] || "s") {
                    case "s":
                        l += parseInt(p[1], 10);
                        break;
        ...
        _generateHTML: function(e) {
            ...
            var _ = e.options.compact ? e.options.compactLabels : e.options.labels
              ...
              , c = function(t) {
                ...
                return a[t] ? i._translateDigits(e, e._periods[t]) + (n ? n[t] : _[t]) + " " : ""
            }
              , u = e.options.padZeroes ? 2 : 1
              , d = function(t) {
                var n = e.options["labels" + p(e._periods[t])];
                return !e.options.significant && a[t] || e.options.significant && l[t] ? '<span class="' + i._sectionClass + '"><span class="' + i._amountClass + '">' + i._minDigits(e, e._periods[t], u) + (n ? n[t] : _[t]) + "</span></span>" : ""
            };
            return e.options.layout ? this._buildLayout(e, a, e.options.layout, e.options.compact, e.options.significant, l) : (e.options.compact ? '<span class="' + this._rowClass + " " + this._amountClass + (e._hold ? " " + this._holdingClass : "") + '">' + c(0) + c(1) + c(2) + c(3) + (a[4] ? this._minDigits(e, e._periods[4], 2) : "") + (a[5] ? (a[4] ? e.options.timeSeparator : "") + this._minDigits(e, e._periods[5], 2) : "") + (a[6] ? (a[4] || a[5] ? e.options.timeSeparator : "") + this._minDigits(e, e._periods[6], 2) : "") : '<span class="' + this._rowClass + " " + this._showClass + (e.options.significant || s) + (e._hold ? " " + this._holdingClass : "") + '">' + d(0) + d(1) + d(2) + d(3) + d(4) + d(5) + d(6)) + "</span>" + (e.options.description ? '<span class="' + this._rowClass + " " + this._descrClass + '">' + e.options.description + "</span>" : "")
        },
        _buildLayout: function(e, i, n, s, o, a) {
            for (var r = e.options[s ? "compactLabels" : "labels"], l = e.options.whichLabels || this._normalLabels, _ = function(t) {
        ...
        _calculatePeriods: function(t, e, i, n) {
            ...
            t._since ? n.getTime() < t._since.getTime() ? t._now = n = s : n = t._since : (s.setTime(t._until.getTime()),
   ...
   */
    ...
    class d {
        constructor(e, t) {
            ...
            void 0 !== o.options.showContols && (o.options.showControls = o.options.showContols,
            ...
            const t = function(e) {
              ...
              , i = function(e) {
                ...
                return t.forEach((e=>{
                    ...
                    t && t[1] && t[2] && (o["ogv" === t[1] ? "ogg" : t[1]] = t[2],
                    i = 1)
                }
                )),
                !!i && o
        ...
        play(e) {
            const o = this;
            o.player && ("youtube" === o.type && o.player.playVideo && (void 0 !== e && o.player.seekTo(e || 0),
            t.YT.PlayerState.PLAYING !== o.player.getPlayerState() && o.player.playVideo()),
            "vimeo" === o.type && (void 0 !== e && o.player.setCurrentTime(e),
            o.player.getPaused().then((e=>{
                e && o.player.play()
            }
            ))),
            "local" === o.type && (void 0 !== e && (o.player.currentTime = e),
            o.player.paused && o.player.play()))
        }
        pause() {
            const e = this;
            e.player && ("youtube" === e.type && e.player.pauseVideo && t.YT.PlayerState.PLAYING === e.player.getPlayerState() && e.player.pauseVideo(),
        ...
        getImageURL(e) {
            ...
            if (t.videoImage)
                ...
                if ("youtube" === t.type) {
                    ...
                    const a = new Image;
                    a.onload = function() {
                        120 !== (this.naturalWidth || this.width) || i === o.length - 1 ? (t.videoImage = `https://img.youtube.com/vi/${t.videoID}/${o[i]}.jpg`,
                        e(t.videoImage)) : (i += 1,
                ...
                if ("vimeo" === t.type) {
                    ...
                    o.onreadystatechange = function() {
                        if (4 === this.readyState && this.status >= 200 && this.status < 400) {
                            ...
                            o.thumbnail_url && (t.videoImage = o.thumbnail_url,
                            e(t.videoImage))
                        }
                    }
                    ,
        ...
        getVideo(e) {
            ...
            o.$video ? e(o.$video) : o.onAPIready((()=>{
                let i;
                if (o.$video || (i = document.createElement("div"),
                ...
                "youtube" === o.type) {
                    ...
                    o.options.showControls || (o.playerOptions.playerVars.iv_load_policy = 3,
                    ...
                    o.playerOptions.events = {
                        onReady(e) {
                            if (o.options.mute ? e.target.mute() : o.options.volume && e.target.setVolume(o.options.volume),
                            ...
                            setInterval((()=>{
                                o.getVolume((t=>{
                                    o.options.volume !== t && (o.options.volume = t,
                        ...
                        onStateChange(i) {
                            o.options.loop && i.data === t.YT.PlayerState.ENDED && o.play(o.options.startTime),
                            e || i.data !== t.YT.PlayerState.PLAYING || (e = 1,
                            o.fire("started", i)),
                            ...
                            i.data === t.YT.PlayerState.PLAYING ? a = setInterval((()=>{
                                o.fire("timeupdate", i),
                                o.options.endTime && o.player.getCurrentTime() >= o.options.endTime && (o.options.loop ? o.play(o.options.startTime) : o.pause())
                            }
                            ), 150) : clearInterval(a)
                        },
                        onError(e) {
                    ...
                    n && (o.$video = document.getElementById(o.playerID),
                    o.options.accessibilityHidden && (o.$video.setAttribute("tabindex", "-1"),
                ...
                if ("vimeo" === o.type) {
                    ...
                    o.options.showControls || (o.playerOptions.badge = 0,
                    ...
                    o.options.startTime && o.options.autoplay && o.player.setCurrentTime(o.options.startTime),
                    ...
                    o.player.on("timeupdate", (t=>{
                        ...
                        e = 1),
                        o.fire("timeupdate", t),
                        o.options.endTime && o.options.endTime && t.seconds >= o.options.endTime && (o.options.loop ? o.play(o.options.startTime) : o.pause())
                    }
                    )),
                    o.player.on("play", (e=>{
                        o.fire("play", e),
                ...
                if ("local" === o.type) {
                    let e;
                    o.$video || (o.$video = document.createElement("video"),
                    o.options.showControls && (o.$video.controls = !0),
                    o.options.mute ? o.$video.muted = !0 : o.$video.volume && (o.$video.volume = o.options.volume / 100),
                    ...
                    o.player.addEventListener("timeupdate", (function(e) {
                        o.fire("timeupdate", e),
                        o.options.endTime && o.options.endTime && this.currentTime >= o.options.endTime && (o.options.loop ? o.play(o.options.startTime) : o.pause())
                    }
                    )),
        ...
        onAPIready(e) {
            ...
            "vimeo" === o.type)
                if (void 0 !== t.Vimeo || l)
                    ...
                    l = 1;
                    const o = setInterval((()=>{
                        void 0 !== t.Vimeo && (clearInterval(o),
                        p.resolve("done"),
                        e())
                    }
                    ), 20)
    ...
    function c(e=m.jarallax) {
        ...
        t.prototype.coverImage = function() {
            ...
            if (t && e.video && o && ("IFRAME" === o || "VIDEO" === o)) {
                let i = t.image.height
                  ...
                  , s = t.image.marginTop;
                t.container.width > a && (a = t.container.width,
        ...
        t.prototype.canInitParallax = function() {
            ...
            if (e.options.onVideoWorkerInit && e.options.onVideoWorkerInit.call(e, o),
            o.isValid())
...
!function($) {
    ...
    a.prototype = {
        ...
        build: function() {
            var a = this;
            if (!0 === this.showCursor && (this.cursor = $('<span class="typed-cursor">' + this.cursorChar + "</span>"),
        ...
        typewrite: function(c, d) {
            if (!0 !== this.stop) {
                ...
                b.timeout = setTimeout(function() {
                    ...
                    if ("^" === a.charAt(0)) {
                        var h = 1;
                        /^\^\d+/.test(a) && (h += (a = /\d+/.exec(a)[0]).length,
                        g = parseInt(a)),
                    ...
                    b.timeout = setTimeout(function() {
                        if (d === c.length)
                            ...
                            b.curLoop++,
                            !1 !== b.loop && b.curLoop !== b.loopCount)) && (b.timeout = setTimeout(function() {
                                b.backspace(c, d)
                            }, b.backDelay));
                        else {
                            0 === d && b.options.preStringTyped(b.arrayPos);
                            var a = c.substr(0, d + 1);
                            b.attr ? b.el.attr(b.attr, a) : b.isInput ? b.el.val(a) : "html" === b.contentType ? b.el.html(a) : b.el.text(a),
                            d++,
                            b.typewrite(c, d)
                        }
                    }, g)
        ...
        backspace: function(c, d) {
            if (!0 !== this.stop) {
                ...
                b.timeout = setTimeout(function() {
                    ...
                    b.attr ? b.el.attr(b.attr, a) : b.isInput ? b.el.val(a) : "html" === b.contentType ? b.el.html(a) : b.el.text(a),
                    d > b.stopNum ? (d--,
                    b.backspace(c, d)) : d <= b.stopNum && (b.arrayPos++,
                    b.arrayPos === b.strings.length ? (b.arrayPos = 0,
                    b.shuffle && (b.sequence = b.shuffleArray(b.sequence)),
                    b.init()) : b.typewrite(b.strings[b.sequence[b.arrayPos]], d))
                }, a)
            }
        },
